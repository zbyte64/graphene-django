...
`django-filter <https://django-filter.readthedocs.io/en/master/>`__ (2.0.0) to provide
...
The context argument is passed on as the `request argument <http://django-filter.readthedocs.io/en/filter/guide/usage.html#request-based-filtering>`__
